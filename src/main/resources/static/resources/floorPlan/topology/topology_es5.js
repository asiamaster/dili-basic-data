...
var Topology = {
    ...
    tools: [
        {
            group: '基本形状',
            children: [
                {name: 'rectangle',icon: 'icon-rect',data: {text: 'Topology',rect: {width: 100,height: 100},paddingLeft: 10,paddingRight: 10,paddingTop: 10,paddingBottom: 10,name: 'rectangle',icon: '\ue64d',iconFamily: 'iconfont',iconColor: '#2f54eb'}},{name: 'rectangle',icon: 'icon-rectangle',data: {text: '圆角矩形',rect: {width: 200,height: 50},paddingLeft: 10,paddingRight: 10,paddingTop: 10,paddingBottom: 10,borderRadius: 0.1,name: 'rectangle'}},{name: 'circle',icon: 'icon-circle',data: {text: '圆',rect: {width: 100,height: 100},name: 'circle',textMaxLine: 1}},{name: 'triangle',icon: 'icon-triangle',data: {text: '三角形',rect: {width: 100,height: 100},name: 'triangle'}},{name: 'diamond',icon: 'icon-diamond',data: {text: '菱形',rect: {width: 100,height: 100},name: 'diamond'}},{name: 'pentagon',icon: 'icon-pentagon',data: {text: '五边形',rect: {width: 100,height: 100},name: 'pentagon'}},{name: 'hexagon',icon: 'icon-hexagon',data: {text: '六边形',rect: {width: 100,height: 100},paddingTop: 10,paddingBottom: 10,name: 'hexagon'}},{name: 'pentagram',icon: 'icon-pentagram',data: {text: '五角星',rect: {width: 100,height: 100},name: 'pentagram'}},{name: 'leftArrow',icon: 'icon-arrow-left',data: {text: '左箭头',rect: {width: 200,height: 100},name: 'leftArrow'}},{name: 'rightArrow',icon: 'icon-arrow-right',data: {text: '右箭头',rect: {width: 200,height: 100},name: 'rightArrow'}},{name: 'twowayArrow',icon: 'icon-twoway-arrow',data: {text: '双向箭头',rect: {width: 200,height: 100},name: 'twowayArrow'}},{name: 'line',icon: 'icon-line',data: {text: '直线',rect: {width: 100,height: 100},name: 'line'}},{name: 'cloud',icon: 'icon-cloud',data: {text: '云',rect: {width: 100,height: 100},name: 'cloud'}},{name: 'message',icon: 'icon-msg',data: {text: '消息框',rect: {width: 100,height: 100},paddingLeft: 10,paddingRight: 10,paddingTop: 10,paddingBottom: 10,name: 'message'}},{name: 'file',icon: 'icon-file',data: {text: '文档',rect: {width: 80,height: 100},paddingLeft: 10,paddingRight: 10,paddingTop: 10,paddingBottom: 10,name: 'file'}},{name: 'text',icon: 'icon-text',data: {text: '文本',rect: {width: 160,height: 30},name: 'text'}},{name: 'cube',icon: 'icon-cube',data: {rect: {width: 50,height: 70},is3D: true,z: 10,zRotate: 15,fillStyle: '#ddd',name: 'cube',icon: '\ue63c',iconFamily: 'topology',iconColor: '#777',iconSize: 30}},{name: 'people',icon: 'icon-people',data: {rect: {width: 70,height: 100},name: 'people'}},{name: '视频/网页',icon: 'icon-pc',data: {text: '',rect: {width: 200,height: 200},paddingLeft: 10,paddingRight: 10,paddingTop: 10,paddingBottom: 10,name: 'div'}},{name: '开始/结束',icon: 'icon-flow-start',data: {text: '',rect: {width: 120,height: 40},borderRadius: 0.5,name: 'rectangle'}},{name: '流程',icon: 'icon-rectangle',data: {text: '',rect: {width: 120,height: 40},name: 'rectangle'}},{name: '数据',icon: 'icon-flow-data',data: {text: '',rect: {width: 120,height: 50},name: 'flowData'}},{name: '子流程',icon: 'icon-flow-subprocess',data: {text: '',rect: {width: 120,height: 50},name: 'flowSubprocess'}},{name: '数据库',icon: 'icon-db',data: {text: '',rect: {width: 80,height: 120},name: 'flowDb'}},{name: '内部存储',icon: 'icon-internal-storage',data: {text: '',rect: {width: 120,height: 80},name: 'flowInternalStorage'}},{name: '手动输入',icon: 'icon-flow-manually',data: {text: '',rect: {width: 120,height: 80},name: 'flowManually'}},{name: '并行模式',icon: 'icon-flow-parallel',data: {text: '',rect: {width: 120,height: 50},name: 'flowParallel'}},{name: '开始',icon: 'icon-inital',data: {text: '',rect: {width: 30,height: 30},name: 'circle',fillStyle: '#555',strokeStyle: 'transparent'}},{name: '结束',icon: 'icon-final',data: {text: '',rect: {width: 30,height: 30},name: 'activityFinal'}},{name: '垂直泳道',icon: 'icon-swimlane-v',data: {text: '',rect: {width: 200,height: 500},name: 'swimlaneV'}}
            ]
    ...
    bindEvent: function () {
        ...
        $(document).on("click", "#down_svg", function () {
            self.down_svg();
        });
        $(document).on("click", "#down_canvas2svg", function () {
            self.down_canvas2svg();
        });
        down_canvas2svg
        // 画布右键属性
    ...
    // 下载图片
    down_png: function () {
        canvas.saveAsImage("png图片.png", "image/png", null);
    },
    down_svg:function(){
        processImage(canvas.toImage("image/svg", null));
    },
    down_canvas2svg:function(){
        doCanvas2svg(canvas);
    },
    // 初始化node
    initNode: function () {
...
function doCanvas2svg(canvas_obj){
    let image64=canvas_obj.toImage("image/svg", null);
    saveImg2svg(image64);
}

function saveImg2svg(image64){
    let down_svg = '<svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" '
        +' x="0px" y="0px" width="1000px" height="462px" viewBox="0 0 1000 462" enable-background="new 0 0 1000 462" xml:space="preserve"> '
        +'  <image id="image0" width="1000" height="462" x="0" y="0"\n'
        +'    href="'
        +image64
        +'"></image></svg>';
    let canvas2svg = document.createElement("a");
    canvas2svg.setAttribute("download", "pixels.svg");
    canvas2svg.setAttribute("href", "data:Application/octet-stream,"+encodeURIComponent(down_svg));
    const o = document.createEvent("MouseEvents");
    o.initEvent("click", !0, !0), canvas2svg.dispatchEvent(o)
}
...
function processImage(src) {
    ...
    img.onload = function() {
        ...
        s.setAttribute("download", "pixels.svg");
        s.setAttribute("href", "data:Application/octet-stream,"+encodeURIComponent(output));
        const o = document.createEvent("MouseEvents");
...
//自定义图标库
function addMyNode(){
    Le5leTopology.registerNode('addNode1', myShape);
}
...
function myShape() {
    ...
    const e =new Le5leTopology.Node(addNodeInfo);
    console.log("==============");
    console.log(e);
    console.log("==============");
    //let addNode1 = canvas.Node(addNodeInfo);
    let ctx=canvas.canvas.canvas.getContext('2d');
    ctx.beginPath();
    ctx.lineTo(0,0);
    ctx.lineTo(0,100);
    ctx.lineTo(50,100);
